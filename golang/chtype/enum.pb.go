...
const (
	...
	TRANSACTION_SUB_TYPE_CHALLEGE     TransactionSubType = 2
...
var TransactionSubType_name = map[int32]string{
	...
	2: "TRANSACTION_SUB_TYPE_CHALLEGE",
...
var TransactionSubType_value = map[string]int32{
	...
	"TRANSACTION_SUB_TYPE_CHALLEGE":     2,
...
var fileDescriptor_13a9f1b5947140c8 = []byte{
	...
	,
}
