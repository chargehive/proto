...
const (
	...
	RESPONSE_ERROR_AVAILABLE_FUNDS ResponseError = 1
	RESPONSE_ERROR_PAYLOAD         ResponseError = 2
	RESPONSE_ERROR_LIMIT           ResponseError = 3
	RESPONSE_ERROR_EXPIRED         ResponseError = 4
	RESPONSE_ERROR_UNAVAILABLE     ResponseError = 5
	RESPONSE_ERROR_UNSUPPORTED     ResponseError = 6
	RESPONSE_ERROR_LOST            ResponseError = 7
	RESPONSE_ERROR_STOLEN          ResponseError = 8
	RESPONSE_ERROR_FRAUD           ResponseError = 9
	RESPONSE_ERROR_PICKUP          ResponseError = 10
	RESPONSE_ERROR_VELOCITY        ResponseError = 11
	RESPONSE_ERROR_ADDRESS         ResponseError = 12
	RESPONSE_ERROR_DUPLICATE       ResponseError = 13
	RESPONSE_ERROR_TIMEOUT         ResponseError = 14
	RESPONSE_ERROR_NOT_FOUND       ResponseError = 15
	RESPONSE_ERROR_DISPUTED        ResponseError = 16
	RESPONSE_ERROR_PERMISSION      ResponseError = 17
	RESPONSE_ERROR_DECLINE         ResponseError = 18
	RESPONSE_ERROR_USER_INPUT      ResponseError = 19
	RESPONSE_ERROR_USER_DEVICE     ResponseError = 20
	RESPONSE_ERROR_ALREADY_DONE    ResponseError = 21
	RESPONSE_ERROR_RETRY           ResponseError = 22
	RESPONSE_ERROR_QUEUED          ResponseError = 23
	RESPONSE_ERROR_UNKNOWN         ResponseError = 24
)

var ResponseError_name = map[int32]string{
	0:  "RESPONSE_ERROR_INVALID",
	1:  "RESPONSE_ERROR_AVAILABLE_FUNDS",
	2:  "RESPONSE_ERROR_PAYLOAD",
	3:  "RESPONSE_ERROR_LIMIT",
	4:  "RESPONSE_ERROR_EXPIRED",
	5:  "RESPONSE_ERROR_UNAVAILABLE",
	6:  "RESPONSE_ERROR_UNSUPPORTED",
	7:  "RESPONSE_ERROR_LOST",
	8:  "RESPONSE_ERROR_STOLEN",
	9:  "RESPONSE_ERROR_FRAUD",
	10: "RESPONSE_ERROR_PICKUP",
	11: "RESPONSE_ERROR_VELOCITY",
	12: "RESPONSE_ERROR_ADDRESS",
	13: "RESPONSE_ERROR_DUPLICATE",
	14: "RESPONSE_ERROR_TIMEOUT",
	15: "RESPONSE_ERROR_NOT_FOUND",
	16: "RESPONSE_ERROR_DISPUTED",
	17: "RESPONSE_ERROR_PERMISSION",
	18: "RESPONSE_ERROR_DECLINE",
	19: "RESPONSE_ERROR_USER_INPUT",
	20: "RESPONSE_ERROR_USER_DEVICE",
	21: "RESPONSE_ERROR_ALREADY_DONE",
	22: "RESPONSE_ERROR_RETRY",
	23: "RESPONSE_ERROR_QUEUED",
	24: "RESPONSE_ERROR_UNKNOWN",
}

var ResponseError_value = map[string]int32{
	"RESPONSE_ERROR_INVALID":         0,
	"RESPONSE_ERROR_AVAILABLE_FUNDS": 1,
	"RESPONSE_ERROR_PAYLOAD":         2,
	"RESPONSE_ERROR_LIMIT":           3,
	"RESPONSE_ERROR_EXPIRED":         4,
	"RESPONSE_ERROR_UNAVAILABLE":     5,
	"RESPONSE_ERROR_UNSUPPORTED":     6,
	"RESPONSE_ERROR_LOST":            7,
	"RESPONSE_ERROR_STOLEN":          8,
	"RESPONSE_ERROR_FRAUD":           9,
	"RESPONSE_ERROR_PICKUP":          10,
	"RESPONSE_ERROR_VELOCITY":        11,
	"RESPONSE_ERROR_ADDRESS":         12,
	"RESPONSE_ERROR_DUPLICATE":       13,
	"RESPONSE_ERROR_TIMEOUT":         14,
	"RESPONSE_ERROR_NOT_FOUND":       15,
	"RESPONSE_ERROR_DISPUTED":        16,
	"RESPONSE_ERROR_PERMISSION":      17,
	"RESPONSE_ERROR_DECLINE":         18,
	"RESPONSE_ERROR_USER_INPUT":      19,
	"RESPONSE_ERROR_USER_DEVICE":     20,
	"RESPONSE_ERROR_ALREADY_DONE":    21,
	"RESPONSE_ERROR_RETRY":           22,
	"RESPONSE_ERROR_QUEUED":          23,
	"RESPONSE_ERROR_UNKNOWN":         24,
}
...
var fileDescriptor_e1fdc72718db4e4d = []byte{
	...
	,
}
