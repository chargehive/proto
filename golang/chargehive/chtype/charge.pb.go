...
const (
	...
	ChargeMetaType_CHARGE_META_TYPE_SOURCE  ChargeMetaType = 1
	ChargeMetaType_CHARGE_META_TYPE_APPEND  ChargeMetaType = 2
)
...
const (
	...
	ChargeIntent_CHARGE_INTENT_METHOD_ADD     ChargeIntent = 1
	ChargeIntent_CHARGE_INTENT_METHOD_REFRESH ChargeIntent = 2
	ChargeIntent_CHARGE_INTENT_METHOD_VERIFY  ChargeIntent = 3
	ChargeIntent_CHARGE_INTENT_CAPTURE        ChargeIntent = 4
...
const (
	...
	ChargeEnvironment_CHARGE_ENVIRONMENT_RETAIL    ChargeEnvironment = 1
	ChargeEnvironment_CHARGE_ENVIRONMENT_ECOMMERCE ChargeEnvironment = 2
	ChargeEnvironment_CHARGE_ENVIRONMENT_MOTO      ChargeEnvironment = 3
	ChargeEnvironment_CHARGE_ENVIRONMENT_RENEWAL   ChargeEnvironment = 4
)
...
var fileDescriptor_8da54e8823fce2f7 = []byte{
	...
	,
}
