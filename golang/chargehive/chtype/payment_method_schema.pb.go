...
const (
	...
	PaymentMethodSchema_PAYMENT_METHOD_SCHEMA_CONNECTOR_TOKEN PaymentMethodSchema = 9
)
...
var (
	PaymentMethodSchema_name = map[int32]string{
		...
		9: "PAYMENT_METHOD_SCHEMA_CONNECTOR_TOKEN",
	}
	PaymentMethodSchema_value = map[string]int32{
		...
		"PAYMENT_METHOD_SCHEMA_CONNECTOR_TOKEN": 9,
	}
)
...
const file_chargehive_chtype_payment_method_schema_proto_rawDesc = "" +
	...
	"\x10transport_key_id\x18\x05 \x01(\tR\x0etransportKeyId*\x81\x03\n" +
	...
	"\x19PAYMENT_METHOD_SCHEMA_RAW\x10\b\x12)\n" +
	"%PAYMENT_METHOD_SCHEMA_CONNECTOR_TOKEN\x10\tBgZ4github.com/chargehive/proto/golang/chargehive/chtype\xca\x02\x11ChargeHive\\Chtype\xe2\x02\x1aChargeHive\\Chtype\\Metadatab\x06proto3"
