...
const (
	...
	PaymentMethodType_PAYMENT_METHOD_TYPE_CONNECTOR_TOKEN PaymentMethodType = 5
)
...
var (
	PaymentMethodType_name = map[int32]string{
		...
		5: "PAYMENT_METHOD_TYPE_CONNECTOR_TOKEN",
	}
	PaymentMethodType_value = map[string]int32{
		...
		"PAYMENT_METHOD_TYPE_CONNECTOR_TOKEN": 5,
	}
)
...
const (
	...
	PaymentMethodProvider_PAYMENT_METHOD_PROVIDER_IMPORT        PaymentMethodProvider = 15
)
...
var (
	PaymentMethodProvider_name = map[int32]string{
		...
		15: "PAYMENT_METHOD_PROVIDER_IMPORT",
	}
	PaymentMethodProvider_value = map[string]int32{
		...
		"PAYMENT_METHOD_PROVIDER_IMPORT":        15,
	}
)
...
const file_chargehive_chtype_enum_proto_rawDesc = "" +
	"\n" +
	"\x1cchargehive/chtype/enum.proto\x12\x11chargehive.chtype*\xc3\x01\n" +
	"\x06Status\x12\x12\n" +
	"\x0eSTATUS_INVALID\x10\x00\x12\x12\n" +
	"\x0eSTATUS_PENDING\x10\x01\x12\x10\n" +
	"\fSTATUS_SETUP\x10\n" +
	"\x12\x17\n" +
	"\x13STATUS_PROVISIONING\x10\x14\x12\x11\n" +
	"\rSTATUS_ACTIVE\x10\x1e\x12\x14\n" +
	"\x10STATUS_SUSPENDED\x102\x12\x14\n" +
	"\x10STATUS_CANCELLED\x10<\x12\x13\n" +
	"\x0fSTATUS_ARCHIVED\x10F\x12\x12\n" +
	"\x0eSTATUS_DELETED\x10Z*\xee\x02\n" +
	"\tActorType\x12\x16\n" +
	"\x12ACTOR_TYPE_INVALID\x10\x00\x12\x17\n" +
	"\x13ACTOR_TYPE_CONSUMER\x10\x01\x12\x17\n" +
	"\x13ACTOR_TYPE_MERCHANT\x10\x02\x12\x19\n" +
	"\x15ACTOR_TYPE_CHARGEHIVE\x10\x03\x12\x15\n" +
	"\x11ACTOR_TYPE_WALLET\x10\x04\x12\x18\n" +
	"\x14ACTOR_TYPE_CONNECTOR\x10\x05\x12 \n" +
	"\x1cACTOR_TYPE_PAYMENT_PROCESSOR\x10\x06\x12\x1e\n" +
	"\x1aACTOR_TYPE_PAYMENT_NETWORK\x10\a\x12\x1d\n" +
	"\x19ACTOR_TYPE_ACQUIRING_BANK\x10\b\x12\x1b\n" +
	"\x17ACTOR_TYPE_ISSUING_BANK\x10\t\x12\x1d\n" +
	"\x19ACTOR_TYPE_RECOVERY_AGENT\x10\n" +
	"\x12\x17\n" +
	"\x13ACTOR_TYPE_EXCHANGE\x10\v\x12\x15\n" +
	"\x11ACTOR_TYPE_POLICY\x10\f*\xa0\x01\n" +
	"\vHandlerType\x12\x18\n" +
	"\x14HANDLER_TYPE_INVALID\x10\x00\x12\x14\n" +
	"\x10HANDLER_TYPE_WEB\x10\x01\x12\x14\n" +
	"\x10HANDLER_TYPE_CLI\x10\x02\x12\x14\n" +
	"\x10HANDLER_TYPE_API\x10\x03\x12\x17\n" +
	"\x13HANDLER_TYPE_MOBILE\x10\x04\x12\x1c\n" +
	"\x18HANDLER_TYPE_PASSTHROUGH\x10\x05*\x9f\x02\n" +
	"\x0fTransactionType\x12\x1c\n" +
	"\x18TRANSACTION_TYPE_INVALID\x10\x00\x12\x1e\n" +
	"\x1aTRANSACTION_TYPE_AUTHORIZE\x10\x01\x12\x1c\n" +
	"\x18TRANSACTION_TYPE_CAPTURE\x10\x02\x12\x1b\n" +
	"\x17TRANSACTION_TYPE_REFUND\x10\x03\x12\x1b\n" +
	"\x17TRANSACTION_TYPE_CANCEL\x10\x04\x12\x1c\n" +
	"\x18TRANSACTION_TYPE_DISPUTE\x10\x05\x12\x1b\n" +
	"\x17TRANSACTION_TYPE_VERIFY\x10\x06\x12\x1c\n" +
	"\x18TRANSACTION_TYPE_EXPIRED\x10\a\x12\x1d\n" +
	"\x19TRANSACTION_TYPE_INTERNAL\x10c*\xc3\x01\n" +
	"\x12TransactionSubType\x12 \n" +
	"\x1cTRANSACTION_SUB_TYPE_INVALID\x10\x00\x12!\n" +
	"\x1dTRANSACTION_SUB_TYPE_IDENTIFY\x10\x01\x12\"\n" +
	"\x1eTRANSACTION_SUB_TYPE_CHALLENGE\x10\x02\x12%\n" +
	"!TRANSACTION_SUB_TYPE_CAPTURE_AUTH\x10\x03\x12\x1d\n" +
	"\x19TRANSACTION_SUB_TYPE_NONE\x10\x04*\xef\x01\n" +
	"\x11PaymentMethodType\x12\x1f\n" +
	"\x1bPAYMENT_METHOD_TYPE_INVALID\x10\x00\x12\x1c\n" +
	"\x18PAYMENT_METHOD_TYPE_CARD\x10\x01\x12%\n" +
	"!PAYMENT_METHOD_TYPE_DIGITALWALLET\x10\x02\x12#\n" +
	"\x1fPAYMENT_METHOD_TYPE_DIRECTDEBIT\x10\x03\x12&\n" +
	"\"PAYMENT_METHOD_TYPE_CRYPTOCURRENCY\x10\x04\x12'\n" +
	"#PAYMENT_METHOD_TYPE_CONNECTOR_TOKEN\x10\x05*\xc5\x02\n" +
	"\x15PaymentMethodProvider\x12#\n" +
	"\x1fPAYMENT_METHOD_PROVIDER_INVALID\x10\x00\x12 \n" +
	"\x1cPAYMENT_METHOD_PROVIDER_FORM\x10\x01\x12\"\n" +
	"\x1ePAYMENT_METHOD_PROVIDER_PAYPAL\x10\x02\x12$\n" +
	" PAYMENT_METHOD_PROVIDER_APPLEPAY\x10\x03\x12%\n" +
	"!PAYMENT_METHOD_PROVIDER_GOOGLEPAY\x10\x04\x12%\n" +
	"!PAYMENT_METHOD_PROVIDER_AMAZONPAY\x10\x05\x12)\n" +
	"%PAYMENT_METHOD_PROVIDER_METHOD_UPDATE\x10\n" +
	"\x12\"\n" +
	"\x1ePAYMENT_METHOD_PROVIDER_IMPORT\x10\x0f*w\n" +
	"\x16PaymentMethodInputType\x12\x16\n" +
	"\x12INPUT_TYPE_INVALID\x10\x00\x12\x17\n" +
	"\x13INPUT_TYPE_PHYSICAL\x10\x01\x12\x16\n" +
	"\x12INPUT_TYPE_VIRTUAL\x10\x02\x12\x14\n" +
	"\x10INPUT_TYPE_PROXY\x10\x03*\xc8\x01\n" +
	"\fContractType\x12\x19\n" +
	"\x15CONTRACT_TYPE_INVALID\x10\x00\x12\x16\n" +
	"\x12CONTRACT_TYPE_NONE\x10\x01\x12\x19\n" +
	"\x15CONTRACT_TYPE_PAYMENT\x10\x02\x12&\n" +
	"\"CONTRACT_TYPE_SUBSCRIPTION_INITIAL\x10\x03\x12&\n" +
	"\"CONTRACT_TYPE_SUBSCRIPTION_RENEWAL\x10\x04\x12\x1a\n" +
	"\x16CONTRACT_TYPE_ONECLICK\x10\x05*\x82\x01\n" +
	"\vEnvironment\x12\x17\n" +
	"\x13ENVIRONMENT_INVALID\x10\x00\x12\x18\n" +
	"\x14ENVIRONMENT_BLACKBOX\x10\x01\x12\x14\n" +
	"\x10ENVIRONMENT_TEST\x10\x02\x12\x14\n" +
	"\x10ENVIRONMENT_LIVE\x10\x03\x12\x14\n" +
	"\x10ENVIRONMENT_MOCK\x10\x04*z\n" +
	"\vProductType\x12\x18\n" +
	"\x14PRODUCT_TYPE_INVALID\x10\x00\x12\x18\n" +
	"\x14PRODUCT_TYPE_PRODUCT\x10\x01\x12\x18\n" +
	"\x14PRODUCT_TYPE_SERVICE\x10\x02\x12\x1d\n" +
	"\x19PRODUCT_TYPE_SUBSCRIPTION\x10\x03*^\n" +
	"\aSKUType\x12\x14\n" +
	"\x10SKU_TYPE_INVALID\x10\x00\x12\x14\n" +
	"\x10SKU_TYPE_PRIMARY\x10\x01\x12\x12\n" +
	"\x0eSKU_TYPE_ADDON\x10\x02\x12\x13\n" +
	"\x0fSKU_TYPE_UPSELL\x10\x03*x\n" +
	"\fDeliveryType\x12\x19\n" +
	"\x15DELIVERY_TYPE_INVALID\x10\x00\x12\x16\n" +
	"\x12DELIVERY_TYPE_NONE\x10\x01\x12\x1a\n" +
	"\x16DELIVERY_TYPE_PHYSICAL\x10\x02\x12\x19\n" +
	"\x15DELIVERY_TYPE_VIRTUAL\x10\x03*\xe8\x01\n" +
	"\x10DeliveryStandard\x12\x1d\n" +
	"\x19DELIVERY_STANDARD_INVALID\x10\x00\x12\x1e\n" +
	"\x1aDELIVERY_STANDARD_SAME_DAY\x10\x01\x12\x1e\n" +
	"\x1aDELIVERY_STANDARD_NEXT_DAY\x10\x02\x12\x1d\n" +
	"\x19DELIVERY_STANDARD_TWO_DAY\x10\x03\x12\x1d\n" +
	"\x19DELIVERY_STANDARD_ECONOMY\x10\x04\x12\x1b\n" +
	"\x17DELIVERY_STANDARD_OTHER\x10\x05\x12\x1a\n" +
	"\x16DELIVERY_STANDARD_NONE\x10\x06*\xb3\x01\n" +
	"\bTermType\x12\x15\n" +
	"\x11TERM_TYPE_INVALID\x10\x00\x12\x16\n" +
	"\x12TERM_TYPE_ONE_TIME\x10\x01\x12\x14\n" +
	"\x10TERM_TYPE_MINUTE\x10\x03\x12\x11\n" +
	"\rTERM_TYPE_DAY\x10\x04\x12\x12\n" +
	"\x0eTERM_TYPE_WEEK\x10\x05\x12\x13\n" +
	"\x0fTERM_TYPE_MONTH\x10\x06\x12\x12\n" +
	"\x0eTERM_TYPE_YEAR\x10\a\x12\x12\n" +
	"\x0eTERM_TYPE_NONE\x10\b*\x9f\x01\n" +
	"\vFailureType\x12\x18\n" +
	"\x14FAILURE_TYPE_INVALID\x10\x00\x12\x15\n" +
	"\x11FAILURE_TYPE_NONE\x10\x01\x12\x15\n" +
	"\x11FAILURE_TYPE_SOFT\x10\x02\x12\x15\n" +
	"\x11FAILURE_TYPE_HARD\x10\x03\x12\x16\n" +
	"\x12FAILURE_TYPE_RETRY\x10\x04\x12\x19\n" +
	"\x15FAILURE_TYPE_INTERNAL\x10\x05*\x81\x03\n" +
	"\x11TransactionResult\x12\x1e\n" +
	"\x1aTRANSACTION_RESULT_INVALID\x10\x00\x12\x1e\n" +
	"\x1aTRANSACTION_RESULT_SUCCESS\x10\x01\x12\x1f\n" +
	"\x1bTRANSACTION_RESULT_DECLINED\x10\x02\x12\x1d\n" +
	"\x19TRANSACTION_RESULT_VERIFY\x10\x03\x12\x1e\n" +
	"\x1aTRANSACTION_RESULT_PENDING\x10\x05\x12&\n" +
	"\"TRANSACTION_RESULT_PENDING_SUCCESS\x10\x06\x12\x1c\n" +
	"\x18TRANSACTION_RESULT_RETRY\x10\a\x12\x1e\n" +
	"\x1aTRANSACTION_RESULT_EXPIRED\x10\b\x12&\n" +
	"\"TRANSACTION_RESULT_PARTIAL_SUCCESS\x10\t\x12\x1e\n" +
	"\x1aTRANSACTION_RESULT_FAILURE\x10\n" +
	"\x12\x1e\n" +
	"\x1aTRANSACTION_RESULT_POLLING\x10\v*\xbc\x01\n" +
	"\x12VerificationStatus\x12\x1f\n" +
	"\x1bVERIFICATION_STATUS_INVALID\x10\x00\x12#\n" +
	"\x1fVERIFICATION_STATUS_NOT_CHECKED\x10\x01\x12\x1e\n" +
	"\x1aVERIFICATION_STATUS_PASSED\x10\x02\x12\x1e\n" +
	"\x1aVERIFICATION_STATUS_FAILED\x10\x03\x12 \n" +
	"\x1cVERIFICATION_STATUS_CONTINUE\x10\x04*\x97\x01\n" +
	"\x11VerifyRequestType\x12\x1f\n" +
	"\x1bVERIFY_REQUEST_TYPE_INVALID\x10\x00\x12 \n" +
	"\x1cVERIFY_REQUEST_TYPE_IDENTIFY\x10\x01\x12!\n" +
	"\x1dVERIFY_REQUEST_TYPE_CHALLENGE\x10\x02\x12\x1c\n" +
	"\x18VERIFY_REQUEST_TYPE_NONE\x10\x03*g\n" +
	"\tLiability\x12\x15\n" +
	"\x11LIABILITY_INVALID\x10\x00\x12\x15\n" +
	"\x11LIABILITY_UNKNOWN\x10\x01\x12\x16\n" +
	"\x12LIABILITY_MERCHANT\x10\x02\x12\x14\n" +
	"\x10LIABILITY_ISSUER\x10\x03*\x90\x02\n" +
	"\x13PlacementCapability\x12 \n" +
	"\x1cPLACEMENT_CAPABILITY_INVALID\x10\x00\x12\"\n" +
	"\x1ePLACEMENT_CAPABILITY_CARD_FORM\x10\x01\x12\"\n" +
	"\x1ePLACEMENT_CAPABILITY_APPLE_PAY\x10\x02\x12#\n" +
	"\x1fPLACEMENT_CAPABILITY_GOOGLE_PAY\x10\x03\x12\x1f\n" +
	"\x1bPLACEMENT_CAPABILITY_PAYPAL\x10\x04\x12\x1e\n" +
	"\x1aPLACEMENT_CAPABILITY_TOKEN\x10\x05\x12)\n" +
	"%PLACEMENT_CAPABILITY_DIRECTDEBIT_FORM\x10\x06BgZ4github.com/chargehive/proto/golang/chargehive/chtype\xca\x02\x11ChargeHive\\Chtype\xe2\x02\x1aChargeHive\\Chtype\\Metadatab\x06proto3"

var (
	file_chargehive_chtype_enum_proto_rawDescOnce sync.Once
	file_chargehive_chtype_enum_proto_rawDescData []byte
)

func file_chargehive_chtype_enum_proto_rawDescGZIP() []byte {
	file_chargehive_chtype_enum_proto_rawDescOnce.Do(func() {
		file_chargehive_chtype_enum_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chargehive_chtype_enum_proto_rawDesc), len(file_chargehive_chtype_enum_proto_rawDesc)))
	})
...
var file_chargehive_chtype_enum_proto_goTypes = []any{
...
func file_chargehive_chtype_enum_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chargehive_chtype_enum_proto_rawDesc), len(file_chargehive_chtype_enum_proto_rawDesc)),
			NumEnums:      21,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
