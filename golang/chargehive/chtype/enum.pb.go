...
const (
	...
	PAYMENT_METHOD_PROVIDER_FORM_USER  PaymentMethodProvider = 1
	PAYMENT_METHOD_PROVIDER_FORM_AGENT PaymentMethodProvider = 2
	PAYMENT_METHOD_PROVIDER_PAYPAL     PaymentMethodProvider = 3
	PAYMENT_METHOD_PROVIDER_APPLEPAY   PaymentMethodProvider = 4
	PAYMENT_METHOD_PROVIDER_GOOGLEPAY  PaymentMethodProvider = 5
	PAYMENT_METHOD_PROVIDER_AMAZONPAY  PaymentMethodProvider = 6
)

var PaymentMethodProvider_name = map[int32]string{
	0: "PAYMENT_METHOD_PROVIDER_INVALID",
	1: "PAYMENT_METHOD_PROVIDER_FORM_USER",
	2: "PAYMENT_METHOD_PROVIDER_FORM_AGENT",
	3: "PAYMENT_METHOD_PROVIDER_PAYPAL",
	4: "PAYMENT_METHOD_PROVIDER_APPLEPAY",
	5: "PAYMENT_METHOD_PROVIDER_GOOGLEPAY",
	6: "PAYMENT_METHOD_PROVIDER_AMAZONPAY",
}

var PaymentMethodProvider_value = map[string]int32{
	"PAYMENT_METHOD_PROVIDER_INVALID":    0,
	"PAYMENT_METHOD_PROVIDER_FORM_USER":  1,
	"PAYMENT_METHOD_PROVIDER_FORM_AGENT": 2,
	"PAYMENT_METHOD_PROVIDER_PAYPAL":     3,
	"PAYMENT_METHOD_PROVIDER_APPLEPAY":   4,
	"PAYMENT_METHOD_PROVIDER_GOOGLEPAY":  5,
	"PAYMENT_METHOD_PROVIDER_AMAZONPAY":  6,
}
...
var fileDescriptor_79326afc23833508 = []byte{
	...
	,
}
