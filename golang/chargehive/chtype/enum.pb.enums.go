...
const (
	ERROR_TYPE_INVALID         = ErrorType_ERROR_TYPE_INVALID
	ERROR_TYPE_NONE            = ErrorType_ERROR_TYPE_NONE
	ERROR_TYPE_AVAILABLE_FUNDS = ErrorType_ERROR_TYPE_AVAILABLE_FUNDS
	ERROR_TYPE_PAYLOAD         = ErrorType_ERROR_TYPE_PAYLOAD
	ERROR_TYPE_LIMIT           = ErrorType_ERROR_TYPE_LIMIT
	ERROR_TYPE_EXPIRED         = ErrorType_ERROR_TYPE_EXPIRED
	ERROR_TYPE_UNAVAILABLE     = ErrorType_ERROR_TYPE_UNAVAILABLE
	ERROR_TYPE_UNSUPPORTED     = ErrorType_ERROR_TYPE_UNSUPPORTED
	ERROR_TYPE_LOST            = ErrorType_ERROR_TYPE_LOST
	ERROR_TYPE_STOLEN          = ErrorType_ERROR_TYPE_STOLEN
	ERROR_TYPE_FRAUD           = ErrorType_ERROR_TYPE_FRAUD
	ERROR_TYPE_PICKUP          = ErrorType_ERROR_TYPE_PICKUP
	ERROR_TYPE_VELOCITY        = ErrorType_ERROR_TYPE_VELOCITY
	ERROR_TYPE_ADDRESS         = ErrorType_ERROR_TYPE_ADDRESS
	ERROR_TYPE_DUPLICATE       = ErrorType_ERROR_TYPE_DUPLICATE
	ERROR_TYPE_TIMEOUT         = ErrorType_ERROR_TYPE_TIMEOUT
	ERROR_TYPE_NOT_FOUND       = ErrorType_ERROR_TYPE_NOT_FOUND
	ERROR_TYPE_DISPUTED        = ErrorType_ERROR_TYPE_DISPUTED
	ERROR_TYPE_PERMISSION      = ErrorType_ERROR_TYPE_PERMISSION
	ERROR_TYPE_DECLINE         = ErrorType_ERROR_TYPE_DECLINE
	ERROR_TYPE_USER_INPUT      = ErrorType_ERROR_TYPE_USER_INPUT
	ERROR_TYPE_USER_DEVICE     = ErrorType_ERROR_TYPE_USER_DEVICE
	ERROR_TYPE_ALREADY_DONE    = ErrorType_ERROR_TYPE_ALREADY_DONE
	ERROR_TYPE_RETRY           = ErrorType_ERROR_TYPE_RETRY
	ERROR_TYPE_QUEUED          = ErrorType_ERROR_TYPE_QUEUED
	ERROR_TYPE_SYSTEM          = ErrorType_ERROR_TYPE_SYSTEM
	ERROR_TYPE_UNKNOWN         = ErrorType_ERROR_TYPE_UNKNOWN
	ERROR_TYPE_NOT_READY       = ErrorType_ERROR_TYPE_NOT_READY
	ERROR_TYPE_DISABLED        = ErrorType_ERROR_TYPE_DISABLED
	ERROR_TYPE_CVV             = ErrorType_ERROR_TYPE_CVV
)
