...
const (
	...
	PAYMENT_METHOD_TYPE_CONNECTOR_TOKEN = PaymentMethodType_PAYMENT_METHOD_TYPE_CONNECTOR_TOKEN
)
...
const (
	...
	PAYMENT_METHOD_PROVIDER_IMPORT        = PaymentMethodProvider_PAYMENT_METHOD_PROVIDER_IMPORT
)
