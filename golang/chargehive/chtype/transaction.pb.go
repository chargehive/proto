...
type TransactionLinks struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	MastercardLinkId string                 `protobuf:"bytes,1,opt,name=mastercard_link_id,json=mastercardLinkId,proto3" json:"mastercard_link_id,omitempty"` // Mastercard Transaction Link Identifier (TLID)
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *TransactionLinks) Reset() {
	*x = TransactionLinks{}
...
func (x *TransactionLinks) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransactionLinks) ProtoMessage() {}

func (x *TransactionLinks) ProtoReflect() protoreflect.Message {
	mi := &file_chargehive_chtype_transaction_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransactionLinks.ProtoReflect.Descriptor instead.
func (*TransactionLinks) Descriptor() ([]byte, []int) {
	return file_chargehive_chtype_transaction_proto_rawDescGZIP(), []int{1}
}

func (x *TransactionLinks) GetMastercardLinkId() string {
	if x != nil {
		return x.MastercardLinkId
	}
	return ""
}
...
type TransactionDetail struct {
	...
	TransactionLinks   *TransactionLinks      `protobuf:"bytes,26,opt,name=transaction_links,json=transactionLinks,proto3" json:"transaction_links,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *TransactionDetail) GetTransactionLinks() *TransactionLinks {
	if x != nil {
		return x.TransactionLinks
	}
	return nil
}
...
type InitialTransactionData struct {
	...
	TransactionLinks *TransactionLinks      `protobuf:"bytes,8,opt,name=transaction_links,json=transactionLinks,proto3" json:"transaction_links,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *InitialTransactionData) Reset() {
	*x = InitialTransactionData{}
	mi := &file_chargehive_chtype_transaction_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InitialTransactionData) Descriptor() ([]byte, []int) {
	return file_chargehive_chtype_transaction_proto_rawDescGZIP(), []int{7}
}
...
func (x *InitialTransactionData) GetTransactionLinks() *TransactionLinks {
	if x != nil {
		return x.TransactionLinks
	}
	return nil
...
const file_chargehive_chtype_transaction_proto_rawDesc = "" +
	...
	"\x15payment_method_issuer\x18\x1e \x01(\tR\x13paymentMethodIssuer\"@\n" +
	"\x10TransactionLinks\x12,\n" +
	"\x12mastercard_link_id\x18\x01 \x01(\tR\x10mastercardLinkId\"\x8e\v\n" +
	...
	"issuerName\x12P\n" +
	"\x11transaction_links\x18\x1a \x01(\v2#.chargehive.chtype.TransactionLinksR\x10transactionLinks\x1aA\n" +
	...
	"\x0fIsPrimaryMethod\x18\x06 \x01(\bR\x0fIsPrimaryMethod\"\xa3\x03\n" +
	...
	"\tmethod_id\x18\a \x01(\tR\bmethodId\x12P\n" +
	"\x11transaction_links\x18\b \x01(\v2#.chargehive.chtype.TransactionLinksR\x10transactionLinksBgZ4github.com/chargehive/proto/golang/chargehive/chtype\xca\x02\x11ChargeHive\\Chtype\xe2\x02\x1aChargeHive\\Chtype\\Metadatab\x06proto3"
...
var file_chargehive_chtype_transaction_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_chargehive_chtype_transaction_proto_goTypes = []any{
	(*Transaction)(nil),            // 0: chargehive.chtype.Transaction
	(*TransactionLinks)(nil),       // 1: chargehive.chtype.TransactionLinks
	(*TransactionDetail)(nil),      // 2: chargehive.chtype.TransactionDetail
	(*VerifyRequestData)(nil),      // 3: chargehive.chtype.VerifyRequestData
	(*ThreeDSResult)(nil),          // 4: chargehive.chtype.ThreeDSResult
	(*VerificationResult)(nil),     // 5: chargehive.chtype.VerificationResult
	(*AttemptDetail)(nil),          // 6: chargehive.chtype.AttemptDetail
	(*InitialTransactionData)(nil), // 7: chargehive.chtype.InitialTransactionData
	nil,                            // 8: chargehive.chtype.TransactionDetail.AdditionalDataEntry
	nil,                            // 9: chargehive.chtype.VerifyRequestData.DataEntry
	nil,                            // 10: chargehive.chtype.VerifyRequestData.MethodDataEntry
	(PaymentMethodType)(0),         // 11: chargehive.chtype.PaymentMethodType
	(TransactionType)(0),           // 12: chargehive.chtype.TransactionType
	(*Amount)(nil),                 // 13: chargehive.chtype.Amount
	(ContractType)(0),              // 14: chargehive.chtype.ContractType
	(TransactionResult)(0),         // 15: chargehive.chtype.TransactionResult
	(FailureType)(0),               // 16: chargehive.chtype.FailureType
	(VerificationStatus)(0),        // 17: chargehive.chtype.VerificationStatus
	(Liability)(0),                 // 18: chargehive.chtype.Liability
	(*FraudResult)(nil),            // 19: chargehive.chtype.FraudResult
	(*ResponseDetail)(nil),         // 20: chargehive.chtype.ResponseDetail
	(TransactionSubType)(0),        // 21: chargehive.chtype.TransactionSubType
	(*timestamppb.Timestamp)(nil),  // 22: google.protobuf.Timestamp
	(PaymentMethodProvider)(0),     // 23: chargehive.chtype.PaymentMethodProvider
	(PaymentMethodInputType)(0),    // 24: chargehive.chtype.PaymentMethodInputType
	(ActorType)(0),                 // 25: chargehive.chtype.ActorType
	(Environment)(0),               // 26: chargehive.chtype.Environment
	(VerifyRequestType)(0),         // 27: chargehive.chtype.VerifyRequestType
}
var file_chargehive_chtype_transaction_proto_depIdxs = []int32{
	2,  // 0: chargehive.chtype.Transaction.details:type_name -> chargehive.chtype.TransactionDetail
	11, // 1: chargehive.chtype.Transaction.payment_type:type_name -> chargehive.chtype.PaymentMethodType
	12, // 2: chargehive.chtype.Transaction.transaction_type:type_name -> chargehive.chtype.TransactionType
	13, // 3: chargehive.chtype.Transaction.request_amount:type_name -> chargehive.chtype.Amount
	13, // 4: chargehive.chtype.Transaction.transacted_amount:type_name -> chargehive.chtype.Amount
	14, // 5: chargehive.chtype.Transaction.contract:type_name -> chargehive.chtype.ContractType
	15, // 6: chargehive.chtype.Transaction.result:type_name -> chargehive.chtype.TransactionResult
	3,  // 7: chargehive.chtype.Transaction.verify_request:type_name -> chargehive.chtype.VerifyRequestData
	16, // 8: chargehive.chtype.Transaction.failure_type:type_name -> chargehive.chtype.FailureType
	17, // 9: chargehive.chtype.Transaction.verified:type_name -> chargehive.chtype.VerificationStatus
	18, // 10: chargehive.chtype.Transaction.liability:type_name -> chargehive.chtype.Liability
	6,  // 11: chargehive.chtype.Transaction.attempt_detail:type_name -> chargehive.chtype.AttemptDetail
	19, // 12: chargehive.chtype.Transaction.fraud_results:type_name -> chargehive.chtype.FraudResult
	20, // 13: chargehive.chtype.Transaction.response:type_name -> chargehive.chtype.ResponseDetail
	21, // 14: chargehive.chtype.Transaction.transaction_sub_type:type_name -> chargehive.chtype.TransactionSubType
	0,  // 15: chargehive.chtype.Transaction.ancillary_transactions:type_name -> chargehive.chtype.Transaction
	22, // 16: chargehive.chtype.Transaction.transaction_time:type_name -> google.protobuf.Timestamp
	23, // 17: chargehive.chtype.Transaction.payment_provider:type_name -> chargehive.chtype.PaymentMethodProvider
	24, // 18: chargehive.chtype.Transaction.payment_input_type:type_name -> chargehive.chtype.PaymentMethodInputType
	25, // 19: chargehive.chtype.TransactionDetail.actor_type:type_name -> chargehive.chtype.ActorType
	13, // 20: chargehive.chtype.TransactionDetail.requested_amount:type_name -> chargehive.chtype.Amount
	13, // 21: chargehive.chtype.TransactionDetail.processed_amount:type_name -> chargehive.chtype.Amount
	13, // 22: chargehive.chtype.TransactionDetail.fee_estimate:type_name -> chargehive.chtype.Amount
	13, // 23: chargehive.chtype.TransactionDetail.fee_actual:type_name -> chargehive.chtype.Amount
	22, // 24: chargehive.chtype.TransactionDetail.start_time:type_name -> google.protobuf.Timestamp
	22, // 25: chargehive.chtype.TransactionDetail.end_time:type_name -> google.protobuf.Timestamp
	26, // 26: chargehive.chtype.TransactionDetail.environment:type_name -> chargehive.chtype.Environment
	20, // 27: chargehive.chtype.TransactionDetail.response:type_name -> chargehive.chtype.ResponseDetail
	5,  // 28: chargehive.chtype.TransactionDetail.verification_result:type_name -> chargehive.chtype.VerificationResult
	8,  // 29: chargehive.chtype.TransactionDetail.additional_data:type_name -> chargehive.chtype.TransactionDetail.AdditionalDataEntry
	18, // 30: chargehive.chtype.TransactionDetail.liability:type_name -> chargehive.chtype.Liability
	1,  // 31: chargehive.chtype.TransactionDetail.transaction_links:type_name -> chargehive.chtype.TransactionLinks
	27, // 32: chargehive.chtype.VerifyRequestData.type:type_name -> chargehive.chtype.VerifyRequestType
	9,  // 33: chargehive.chtype.VerifyRequestData.data:type_name -> chargehive.chtype.VerifyRequestData.DataEntry
	26, // 34: chargehive.chtype.VerifyRequestData.environment:type_name -> chargehive.chtype.Environment
	10, // 35: chargehive.chtype.VerifyRequestData.methodData:type_name -> chargehive.chtype.VerifyRequestData.MethodDataEntry
	22, // 36: chargehive.chtype.ThreeDSResult.timestamp:type_name -> google.protobuf.Timestamp
	18, // 37: chargehive.chtype.ThreeDSResult.liability:type_name -> chargehive.chtype.Liability
	4,  // 38: chargehive.chtype.VerificationResult.threeds_result:type_name -> chargehive.chtype.ThreeDSResult
	12, // 39: chargehive.chtype.InitialTransactionData.transaction_type:type_name -> chargehive.chtype.TransactionType
	22, // 40: chargehive.chtype.InitialTransactionData.transaction_time:type_name -> google.protobuf.Timestamp
	1,  // 41: chargehive.chtype.InitialTransactionData.transaction_links:type_name -> chargehive.chtype.TransactionLinks
