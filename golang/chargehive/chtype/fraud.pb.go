...
var file_chargehive_chtype_fraud_proto_goTypes = []interface{}{
...
func file_chargehive_chtype_fraud_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chargehive_chtype_fraud_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chargehive_chtype_fraud_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chargehive_chtype_fraud_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
