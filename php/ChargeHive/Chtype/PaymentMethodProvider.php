...
class PaymentMethodProvider
{
    ...
    /**
     * Generated from protobuf enum <code>PAYMENT_METHOD_PROVIDER_APPLE_APPSTORE = 6;</code>
     */
    const PAYMENT_METHOD_PROVIDER_APPLE_APPSTORE = 6;
    /**
     * Generated from protobuf enum <code>PAYMENT_METHOD_PROVIDER_GOOGLEPLAY = 7;</code>
     */
    const PAYMENT_METHOD_PROVIDER_GOOGLEPLAY = 7;
    ...
    private static $valueToName = [
        ...
        self::PAYMENT_METHOD_PROVIDER_APPLE_APPSTORE => 'PAYMENT_METHOD_PROVIDER_APPLE_APPSTORE',
        self::PAYMENT_METHOD_PROVIDER_GOOGLEPLAY => 'PAYMENT_METHOD_PROVIDER_GOOGLEPLAY',
    ];
